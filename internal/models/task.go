...
type TaskDetails struct {
	...
	CustomerNames  []string      `json:"customer_names"`  // Name of the customers associated with the task
	CustomerLogins []string      `json:"customer_logins"` // Login identifier of the customers
